...
int main(void)
{
    ...
    case 3 :
        ...
        break;
    case 4 :
        std::cout << std::setprecision(6) << 500. / 3 << '\n';
        break;
    case 5 :
        std::cout << 15 << '\n';
        break;
    case 6 :
        std::cout << std::sqrt(6. * 6 + 9 * 9) << '\n';
        break;
    case 7 :
        std::cout << 110 << '\n' << 90 << '\n' << 0 << '\n';
        break;
    case 8 :
        std::cout << 2 * 5 * 3.141593 << '\n';
        std::cout << 5 * 5 * 3.141593 << '\n';
        std::cout << 4 * 5 * 5 * 5 * 3.141593 / 3 << '\n';
        break;
    case 9 :
        std::cout << 22 << '\n';
        break;
    ...
    case 11 :
        ...
        break;
    case 12 :
        std::cout << static_cast<int>('M' - 'A' + 1) << '\n';
        std::cout << static_cast<char>('A' - 1 + 18) << '\n';
        break;
    case 13 :
        std::cout << 16 << '\n';
        break;
